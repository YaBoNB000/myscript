-- HalloweenCountdown (ModuleScript)
...
local v_u_6 = DateTime.fromUniversalTime(2025, 10, 17, 16, 0, 0).UnixTimestamp
function v1.Initialize()
	-- upvalues: (copy) v_u_6, (copy) v_u_5, (copy) v_u_3, (copy) v_u_4
	local v_u_7 = workspace:WaitForChild("HalloweenCountdown"):WaitForChild("Sign")
	...
	task.spawn(function()
		...
		local v11, v12 = pcall(function()
			-- upvalues: (ref) v_u_3
			return v_u_3:GetEventRsvpStatusAsync("1038109778472862334")
		end)
			...
			v_u_13.Triggered:Connect(function(p14)
				...
				if p14 == v_u_4 then
					pcall(function()
						...
						if v_u_3:PromptRsvpToEventAsync("1038109778472862334") == Enum.RsvpStatus.Going then
							v_u_13:Destroy()
						end
					end)
				end
