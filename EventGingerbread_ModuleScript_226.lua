...
local function v_u_27(p10, p_u_11, p12, p_u_13)
	...
	local v_u_14 = v_u_2.Models.Other.Gingerbread:Clone()
	...
	v_u_14.CollisionGroup = "Gingerbread"
	v_u_14:PivotTo(p10)
	...
	v17.MoneyLabel.Text = string.format("%s", v_u_6(p_u_11))
	v17.MoneyLabel.TextColor3 = Color3.fromRGB(170, 85, 0)
	...
	local function v_u_20()
		...
		if v_u_14 and v_u_14.Parent then
			v_u_8.FireServer("collectGingerbread", p_u_11)
			v_u_5(v_u_14.CFrame.Position, 1, "Gingerbread")
	...
	if p12 == nil then
		task.defer(function()
			...
			local v24 = Vector3.new(v21, v22, v23(-22, 22)) * p_u_13 * 1.35
