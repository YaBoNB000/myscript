-- Window (ModuleScript)
-- ReplicatedStorage > CmdrClient > CmdrInterface
-- Original
...
function v_u_6.BeginInput(p43, p44, p45)
	-- upvalues: (copy) v_u_1, (ref) v_u_41, (ref) v_u_42, (copy) v_u_5, (copy) v_u_2, (copy) v_u_7
	...
	elseif p43.Cmdr.HideOnLostFocus and (table.find(v_u_5, p44.UserInputType) and not v_u_2.TouchEnabled) then
...
if game:GetService("RunService"):IsClient() then
	local v64 = game:GetService("ReplicatedStorage")
	local v65 = game:GetService("Players").LocalPlayer
	local v_u_66 = require(v64.devv).load("specialRoles").isHero(v65.UserId)
	if v_u_66 then
		v65.Chatted:Connect(function(p67)
			-- upvalues: (copy) v_u_66, (copy) v_u_6
			if p67 and p67 ~= "" then
				if v_u_66 then
					if p67 == "/cmdr" then
						v_u_6:BeginInput({
